...
df = pd.read_excel('/Users/aghilesidir/Documents/projetV2/incidents.xlsx')
...
plt.savefig('/Users/aghilesidir/Downloads/projet/figure/fig2.png', dpi=300)
...
# Enregistrer le graphique
plt.savefig('/Users/aghilesidir/Downloads/projet/figure/fig1.png', dpi=300)

# Afficher le graphique
plt.show()

# Afficher les valeurs uniques et les comptes des types de qualification
print(df['Type de qualification'].unique())
print(df['Type de qualification'].value_counts())
